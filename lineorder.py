...
class LineOrder(Packet):
    ...
    fields_desc = [
        ...
        LongField('lo_linenumber', None),
        LongField('lo_custkey', None),
        LongField('lo_partkey', None),
        LongField('lo_suppkey', None), 
        ...
        LongField('lo_quantity', None),
        XLongField('lo_extendedprice', None),
        XLongField('lo_ordtotalprice', None),
        XLongField('lo_discount', None),
        XLongField('lo_revenue', None),
        XLongField('lo_supplycost', None),
        XLongField('lo_tax', None),
